...
Version  : 1.2.12
Release  : 79
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/mapproj_1.2.12.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/mapproj_1.2.12.tar.gz
...
%setup -q -n mapproj
pushd ..
cp -a mapproj buildavx2
popd
pushd ..
cp -a mapproj buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747752265
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/mapproj/libs/mapproj.so
/V4/usr/lib64/R/library/mapproj/libs/mapproj.so
